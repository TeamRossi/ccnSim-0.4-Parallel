...
class zipf_sampled {
    ...
    private:
        ...
        double lambda;
        unsigned long down;							// Downscaling factor;
        unsigned long long newCard;						// Downscaled cardinality;
    ...
    public:
        ...
        zipf_sampled(unsigned long long newCardinality, double alpha, double rate, unsigned long downF){
            ...
            if(downF > 1)						// TTl-based scenario
            	numberOfElements = downF*newCardinality;  // Modified for Parallel-Naive
