...
class base_cache : public abstract_node{
    ...
    protected:
		...
		virtual double get_tc_name_node() = 0;
    ...
    public:
		...
		// Only for TTL-based caches
		virtual double get_avg_size(){cout<<"Not implemented"<<endl;}
		virtual double get_max_size(){cout<<"Not implemented"<<endl;}
		virtual double get_nameCache_avg_size(){cout<<"Not implemented"<<endl;}
		virtual bool check_if_two_ttl(){cout<<"Not implemented"<<endl;}
